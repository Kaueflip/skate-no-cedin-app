  ...
  return (
    <main className="min-h-screen bg-black text-white">
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto flex max-w-7xl flex-col items-center px-6 py-24 text-center lg:py-36">
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row">
            ...
            <a
              href="#sobre"
              className="rounded-2xl border border-white/20 bg-white/5 px-8 py-4 text-base font-semibold backdrop-blur transition hover:bg-white/10"
            >
              Conhecer Projeto
            </a>
          </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        <div className="rounded-[2rem] border border-white/10 bg-gradient-to-br from-zinc-900 to-black p-10 lg:p-16">
